    ...
    <div class="max-w-md mx-auto px-4 pt-5 pb-4">
      ...
      <div class="mb-4 fade-up vpn-notice">
        ...
        <div>
          ...
          တချို့သော ပွဲစဉ်များ သို့မဟုတ် Server များသည် မိမိအင်တာနက်လိုင်းဖြင့် တိုက်ရိုက်ကြည့်မရပါက <b>VPN</b> အသုံးပြု၍ ကြည့်ရှုပေးပါ။ 1DM အစရှိသော ပြင်ပ Player များဖြင့်လည်း Copy Link ယူ၍ ကြည့်နိုင်ပါသည်။
        </div>
      </div>
